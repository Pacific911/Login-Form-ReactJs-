					...
					<div className="w-full h-auto bg-gray-400 hidden lg:block lg:w-1/2 bg-cover rounded-l-lg" style={{backgroundImage: `url(${photo})`}}></div>						
					   <div className="w-full lg:w-1/2 bg-white pt-3 rounded-lg lg:rounded-l-none">
						  <div className="px-6 mb-4 text-center">
							<p className="mb-4 text-sm text-blue-600 text-2xl">Login Into Your Account.</p>					
			...
			<form className="px-9 pt-0 pb-6 mb-0 bg-white rounded">
				 <div className="mb-4">
					<label className="block mb-2 text-sm font-bold text-gray-700" for="email">Email Address</label>	
						<input className="w-full px-3 py-2 text-sm leading-tight text-gray-700  border border rounded  appearance-none focus:outline-none focus:border-blue-700 focus:ring-blue-700 focus:ring-1" id="email" type="email" placeholder=""/>								
							</div>
								<div className="mb-4">
									<label className="block mb-2 text-sm font-bold text-gray-700" for="email">Password</label>
									<input className="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded  appearance-none focus:outline-none focus:border-blue-700 focus:ring-blue-700 focus:ring-1" id="email" type="password" placeholder="******************"/>								
									...
									<div className="mb-6 text-center">
										<button className="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full hover:bg-darkblue-700 focus:outline-none focus:shadow-outline bg-darkblue-600 hover:bg-sky-500 " type="button">Sign In</button>	
									</div>
